...
(121, 45, 'Lorsque l ont ulise l héritage','When we use the legacy',TRUE),
(122, 45, 'Lors de la récursivité','During recursion',FALSE),
(123, 45, 'Lors de l itération','During iteration',FALSE),
(124, 45, 'Si tu veux te compliqué la vie parce que Java','If you want to complicate your life because Java',FALSE),
...
(126, 46, 'Il est préférable d utilisé l énumération lorsque l on utilise l héritage','It is preferable to use enumeration when using inheritance',FALSE),
...
(148, 51, 'C est vraiment important ?','That s really important ?',FALSE),
...
(164, 55, 'StackOverflow à la réponse','StackOverflow has the answer',FALSE),
...
(177, 58, 'Elle utilise le protocol JSP','She use the JSP protocol',FALSE),
...
(204, 65, 'Une commande qui permet d afficher toutes les données qui vont changées dans le futur.', 'A command that allows to display all the data that will change in the future.', FALSE),
...
(225, 70, 'Tout les réponses sont vrais', 'All of the answers are true', TRUE),
