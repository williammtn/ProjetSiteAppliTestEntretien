...
(117, 44, 'Ecrire un petit paragraphe concernant mes expériences sur mon CV','Write a small paragraph about my experiences on my CV',FALSE),
...
(121, 45, 'Lorsque l''ont utilise l héritage','When we use the legacy',TRUE),
(122, 45, 'Lors de la récursivité','During recursion',FALSE),
(123, 45, 'Lors de l''itération','During iteration',FALSE),
(124, 45, 'Si tu veux te compliquer la vie parce que Java','If you want to complicate your life because Java',FALSE),
(125, 46, 'Les énumérations sont traitées comme des types de données, et vous pouvez ainsi les utiliser pour créer des ensembles de constantes à utiliser avec des variables et des propriétés','Enumerations are treated as data types, so you can use them to create sets of constants for use with variables and properties',TRUE),
(126, 46, 'Il est préférable d''utiliser l''énumération lorsqu''on utilise l''héritage','It is preferable to use enumeration when using inheritance',FALSE),
(127, 46, 'Bah tu l''utilise pas','Well you don''t use it',FALSE),
(128, 46, 'Cé koi l''énumération ?','What is the enumeration',FALSE),
(129, 47, 'On les utilise : lorsqu''on a besoin de l''héritage mais que certaines méthodes n ont pas de sense à être définie','We use them: when we need inheritance but some methods have no sense to be defined',TRUE),
(130, 47, 'On les utilise lorsqu''on a besoin de l''énumération','We use them when we need the enumeration',FALSE),
(131, 47, 'On ne les utilise pas','We don t use them',FALSE),
(132, 47, 'Jsp c''est quoi','I don t know what is this',FALSE),
(133, 48, 'Unlimited Datagram Protocol','Unlimited Datagram Protocol',FALSE),
(134, 48, 'Unleashed Datagram Protocol','Unleashed Datagram Protocol',FALSE),
(135, 48, 'User Datagram protocol','User Datagram Protocol',TRUE),
(136, 48, 'Unable Datagram Protocol','Unable Datagram Protocol',FALSE),
(137, 49, 'Transformation Control Protocol','Transformation Control Protocol',FALSE),
(138, 49, 'Train Control Protocol','Train Control Protocol',FALSE),
(139, 49, 'Transmission Control Protocol','Transmission Control Protocol',TRUE),
(140, 49, 'Titi Cartoon Production','Titi Cartoon Production',FALSE),
(141, 50, 'Le protocole établit une connexion','The protocol establishes a connection',FALSE),
(142, 50, 'Le protocole n établit pas de connexion','The protocol does not establish a connection',TRUE),
(143, 50, 'C''est un truc de réseau','Its a network thing',FALSE),
(144, 50, 'Le protocole UDP permet aux applications d''accéder directement à un service de transmission de datagrammes','The UDP protocol allows applications to directly access a datagram transmission service',FALSE),
(145, 51, 'IEEE 802 est un comité de l''IEEE (Institute of Electrical and Electronics Engineers)','IEEE 802 is a committee of the IEEE (Institute of Electrical and Electronics Engineers)',TRUE),
(146, 51, 'IEEE 802 est un article du code pénal','IEEE 802 is an article of the penal code',FALSE),
(147, 51, 'IEEE 802 est un comité de l''IEEE (Initiation of Enigmatic and Elevated Engineers)','IEEE 802 is a committee of the IEEE (Initiation of Enigmatic and Elevated Engineers)',FALSE),
(148, 51, 'C''est vraiment important ?',' Is that really important ?',FALSE),
(149, 52, 'Throw c''est lancer et Throws c''est jeter','Throw is throw and Throws is throws',FALSE),
...
(152, 52, 'Throw c''est jeter et Throws c''est lancer','Throw is throws and Throws is throw',FALSE),
(153, 53, 'Oui','Yes',FALSE),
(154, 53, 'Je sais pas','I don t know',FALSE),
(155, 53, 'Non','No',TRUE),
(156, 53, 'Finalement oui','Finally yes',FALSE),
(157, 54, 'Que les variables','Only the variables',FALSE),
(158, 54, 'Que les méthodes','Ony the methods',FALSE),
(159, 54, 'Les 2 sont possibles','Both are possible',TRUE),
(160, 54, 'Oui mais en les spécifiant abstract','Yes, but specifying them as abstract',FALSE),
(161, 55, 'Oui','Yes',FALSE),
(162, 55, 'Non','No',TRUE),
(163, 55, 'Aucune idée','No idea',FALSE),
(164, 55, 'StackOverflow a la réponse','StackOverflow has the answer',FALSE),
(165, 56, 'Vrai','True',FALSE),
(166, 56, 'Faux','False',TRUE),
(168, 56, 'Peut être', 'Maybe',FALSE),
(169, 56, 'Toujours StackOverflow','Always StackOverflow',FALSE),
(170, 57, 'L''interface est assez proche de la classe abstraite, mais aucune méthode n''est implémentée dedans','The interface is quite similar to the abstract class, but no method is implemented in it',TRUE),
(171, 57, 'La classe abstraite est assez proche de l interface, mais aucune méthode n''est implémentée dedans','The abstract class is quite close to the interface, but no method is implemented in it',FALSE),
(172, 57, 'Aucune différence','No difference',FALSE),
(173, 57, 'Le nom','The name',FALSE),
(174, 58, 'Vrai','True',FALSE),
(175, 58, 'Faux','False',TRUE),
(176, 58, 'Aucune idée','No idea',FALSE),
(177, 58, 'Elle utilise le protocol JSP','It uses the JSP protocol',FALSE),
(178, 59, 'RFC 2671','RFC 2671',FALSE),
(179, 59, 'RFC 1267','RFC 1267',FALSE),
(180, 59, 'RFC 1627','RFC 1627',FALSE),
(181, 59, 'RFC 2617','RFC 2617',TRUE),
(182, 60, 'Bloc','Block',FALSE),
(183, 60, 'For','For',FALSE),
(184, 60, 'Tableau','Table',TRUE),
(185, 60, 'If','If',FALSE),
(186, 61, 'Les collections sont des objets qui permettent de gérer des ensembles d objets.', 'Collections are objects that allow to manage sets of objects.', TRUE),
...
(194, 63, 'Un type de jointure qui permet de prendre des données d une autre base de données', 'A type of join that allows you to take data from another database', FALSE),
(195, 63, 'Un type de jointure qui renvoit les valeurs correspondantes et les valeurs non correspondantes de soit l une, soit l autre, soit des deux tables.', 'A join type that returns matching and non-matching values from either or both tables.', TRUE),
(196, 63, 'Une jointure inutile. Autant utilisé INNER JOIN.', 'A useless join. Might as well use INNER JOIN.', FALSE),
(197, 63, 'Un type de jointure qui ne renvoit que les valeurs des clés primaires.', 'A join type that returns only the values of the primary keys.', FALSE),
(198, 64, 'Une commande qui permet de voir les données d''une table', 'A command that allows to see the data of a table', FALSE),
(199, 64, 'Une commande qui permet de limiter ce qu''un utilisateur peut voir dans une table.', 'A command to limit what a user can see in a table.', FALSE),
(200, 64, 'Une synthèse d''une requête d interrogation de la base.', 'A synthesis of a database query.', TRUE),
(201, 64, 'Une librairie SQL.', 'A SQL library.', FALSE),
(202, 65, 'Un déclencheur permet d''exécuter un ensemble d''instruction SQL juste après un événement.', 'A trigger allows to execute a set of SQL statements just after an event.', TRUE),
(203, 65, 'Un type de jointure qui permet d''afficher les valeurs NOT NULL.', 'A join type that allows NOT NULL values to be displayed.', FALSE),
(204, 65, 'Une commande qui permet d afficher toutes les données qui vont changer dans le futur.', 'A command that allows to display all the data that will change in the future.', FALSE),
(205, 65, 'Un type de données.', 'A data type.', FALSE),
(206, 66, 'Un type de biscuit.', 'A type of biscuit.', TRUE),
(207, 66, 'Petit fichier déposé sur le disque dur à l''insu de l''internaute, lors de la consultation de certains sites web, et qui conserve des informations en vue d une connexion ultérieure.', 'A small file deposited on the hard disk without the user s knowledge when visiting certain websites, which stores information for later connection.', TRUE),
(208, 66, 'Un type de virus.','A type of virus.', FALSE),
(209, 66, 'Une commande SQL.','An SQL command.', FALSE),
(210, 67, 'La couche de réseau.', 'The network layer.', FALSE),
(211, 67, 'La couche physique.', 'The physical layer.', FALSE),
(212, 67, 'La couche application.', 'The application layer.', FALSE),
(213, 67, 'La couche de transport.', 'The transport layer.', TRUE),
(214, 68, 'La connection wifi.', 'Wifi connection.', FALSE),
...
(223, 70, 'Délai d''attente', 'Waiting period', FALSE),
(224, 70, 'Délai de transmission', 'Time of transmission', FALSE),
(225, 70, 'Toutes les réponses sont vrais', 'All of the answers are true', TRUE),
(226, 71, 'On regarde dans la console.', 'We look at the console.', TRUE),
(227, 71, 'On rallume sa connection.', 'We restart our connection.', FALSE),
(228, 71, 'On éteint et on rallume le site.', 'We restart the website.', FALSE),
(229, 71, 'On abandonne.', 'We give up.', FALSE),
(230, 72, 'Aucune.', 'None', FALSE),
(231, 72, '!== attribue aussi une valeur.', '!== also assigns a value.', FALSE),
(232, 72, '!== vérifie aussi le type.', '!== also checks the type.', TRUE),
(233, 72, '!== n existe pas.', '!== doesnt exist.', FALSE),
(234, 73, 'A definir une constante.', 'To define a constant.', TRUE),
(235, 73, 'Cette fonction n existe pas.', 'This function doesnt exist.', FALSE),
(236, 73, 'C est une fonction utilisé pour définir un constructeur.', 'Its a function used to  define a constructor.', FALSE),
(237, 73, 'Cette fonction n est plus utilisé.', 'This functions isnt used anymore.', FALSE),
(238, 74, 'Un moteur de réécriture est un composant logiciel qui effectue la réécriture des URL en modifiant leur apparence.', 'A rewrite engine is a software component that rewrites URLs by changing their appearance.', TRUE),
(240, 74, 'Une librairie PHP.', 'A PHP library.', FALSE),
(241, 74, 'Un type de serveur.', 'A type of server.', FALSE),
(242, 74, 'Un langage de programmation.', 'A programming language.', FALSE),
(243, 75, 'Un garbage collector est un sous-système informatique de gestion automatique de la mémoire.', 'A garbage collector is a computer subsystem for automatic memory management.', TRUE),
(244, 75, 'Un synonyme d eboueur.', 'A synonym for garbage man.', FALSE),
(245, 75, 'Une librarie en Java.', 'A Java library.', FALSE),
(246, 75, 'Un des pilliers de POO.', 'One of the pillars of OOP.', FALSE),
(247, 76, 'En demandant gentiment de ne pas le faire.', 'By asking nicely not to do it.', FALSE),
(248, 76, 'En ne mettant pas de cookies dans son site.', 'By not puttin cookies in your website.', FALSE),
(249, 76, 'En filtrant les caractères spéciaux comme les chevrons dans les espaces commentaires, inputs pour se connecter etc.', 'By filtering out special characters like chevrons in comment spaces, inputs to connect etc.', TRUE),
(250, 76, 'Grâce à un antivirus.', 'With an antivirus.', FALSE),
(251, 77, 'Nouveau, executable, bloqué, attendre, résilié.', 'New, executable, blocked, waiting, terminated.', TRUE),
(252, 77, 'Il nait et il meurt.', 'Hes born and then he dies.', FALSE),
(253, 77, 'Un thread Java n''a pas de vie.', 'A Java thread isnt alive.', FALSE),
(254, 77, 'Personne ne sait.', 'Nobody knows.', FALSE),
(255, 78, 'Par hasard.', 'Randomly.', FALSE),
(256, 78, 'Seuls les objets qui n y font plus référence sont éligibles au ramasse-miettes en Java.', 'Only objects that no longer refer to it are eligible for the garbage collector in Java.', TRUE),
(257, 78, 'Java n a pas de garbage collection.', 'Java doesnt have any garbage collection.', FALSE),
(258, 78, 'En demandant.', 'By asking.', FALSE),
(259, 79, 'Avec import()', 'With import()', TRUE),
(260, 79, 'Par le constructeur.', 'By the constructor.', TRUE),
(261, 79, 'Il ne faut pas injecter ses dépendances, sinon il y aura des problèmes de sécurité.', 'You should not inject your dependencies, otherwise there will be security problems.', FALSE),
(262, 79, 'En mettant tout dans un seul fichier.', 'By putting everything in a single file.', FALSE),
