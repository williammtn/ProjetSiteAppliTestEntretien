...
(49, 'Quel est la signification de TCP en réseau ?','What is the meaning of networked TCP?',2,1,TRUE,TRUE,TRUE,NULL,NULL),
...
(68, 'Quel média de transmission à la vitesse de transmission la plus élevée dans un réseau?','Which transmission medium has the highest transmission speed in a network?',2,1,TRUE,TRUE,TRUE,NULL,NULL),
...
(125, 45, 'Lorsque l''ont utilise l héritage','When we use the legacy',TRUE),
...
(133, 47, 'On les utilise : lorsqu''on a besoin de l''héritage mais que certaines méthodes n ont pas de sense à être définie','We use them: when we need inheritance but some methods have no sense to be defined',TRUE),
...
(190, 61, 'Les collections sont ensembles de fonctions.', 'Collections are sets of functions.', FALSE),
...
(199, 63, 'Une jointure inutile. Autant utilisé INNER JOIN.', 'A useless join. Might as well use INNER JOIN.', FALSE),
...
(210, 66, 'Petit fichier déposé sur le disque dur à l''insu de l''internaute, lors de la consultation de certains sites web, et qui conserve des informations en vue d une connexion ultérieure.', 'A small file deposited on the hard disk without the user s knowledge when visiting certain websites, which stores information for later connection.', TRUE),
...
(228, 70, 'Toutes les réponses sont vrais', 'All of the answers are true', TRUE),
...
(239, 73, 'C est une fonction utilisé pour définir un constructeur.', 'Its a function used to  define a constructor.', FALSE),
(240, 73, 'Cette fonction n est plus utilisé.', 'This functions isnt used anymore.', FALSE),
(241, 74, 'Un moteur de réécriture est un composant logiciel qui effectue la réécriture des URL en modifiant leur apparence.', 'A rewrite engine is a software component that rewrites URLs by changing their appearance.', TRUE),
...
(246, 75, 'Un synonyme d eboueur.', 'A synonym for garbage man.', FALSE),
...
(263, 79, 'Il ne faut pas injecter ses dépendances, sinon il y aura des problèmes de sécurité.', 'You should not inject your dependencies, otherwise there will be security problems.', FALSE),
